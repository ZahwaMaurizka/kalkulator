...
<body>
    <div class="container mt-5">
        <div class="calculator bg-light">
            <div class="card">
                <div class="text-end mb-1 p-2">
                    <!-- Toggle switch untuk mode gelap -->
                    <label class="form-check-label me-2">Tema Gelap</label>
                ...
                <div class="card-body">
                    <form method="post">
                        <!-- Tampilan Display -->
                        <input type="text" class="form-control mb-3" name="display" id="display" readonly value="<?php echo isset($_POST['display']) ? $_POST['display'] : ''; ?>">
